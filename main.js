...
eval("{\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://rentex/./node_modules/css-loader/dist/runtime/noSourceMaps.js?\n}");
...
eval("{\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://rentex/./node_modules/style-loader/dist/runtime/insertStyleElement.js?\n}");
...
eval("{\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://rentex/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?\n}");
...
eval("{\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://rentex/./node_modules/style-loader/dist/runtime/styleTagTransform.js?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _tenant_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tenant.js */ \"./src/tenant.js\");\n/* harmony import */ var _landlord_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./landlord.js */ \"./src/landlord.js\");\n\n\n\n\nconst tenant = new _tenant_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('Alex Morgan', 'alex@rentex.com', 1200);\nconst landlord = new _landlord_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('Domenico','domenico@rentex.com','IT-992384');\n\nconsole.log('-----Rentex Frontend Loaded-----');\nconsole.log(tenant.getDetails());\nconsole.log(`Landlord Fee: ${landlord.calculateMonthlyFee(tenant.monthly_rent)}`)\n\nconst appDiv = document.getElementById('app')\nif(appDiv){\n    appDiv.innerHTML = `<h1>Welcome back, ${tenant.name}!</h1>`\n}\n\n//# sourceURL=webpack://rentex/./src/index.js?\n}");
